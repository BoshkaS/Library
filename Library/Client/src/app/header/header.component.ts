...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  navigateToBookmarks() {
    this.router.navigate([`profile/${this.userDTO.id}/bookmarks`]);
  }

  navigateToBorrows() {
    this.router.navigate([`profile/${this.userDTO.id}/borrows`]);
  }

  navigateToSettings() {
    this.router.navigate([`profile/${this.userDTO.id}/settings`]);
  }

  navigateToReservations() {
    this.router.navigate([`profile/${this.userDTO.id}/reservations`]);
  }
