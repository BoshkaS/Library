        ...
        IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
        ...
        protected override async void OnModelCreating(ModelBuilder builder)
        {
            var annotationCollection = new List<IEntityAnnotation>
            {
                ...
                new BookCopyAnnotation(builder),
                new LikedBookAnnotation(builder),
                new BorrowRequestAnnotation(builder),
                new ReservationAnnotation(builder),
                new UserRatingAnnotation(builder),
            };
        ...
        public DbSet<BorrowExtensionRequest> BorrowRequest { get; set; }

        public DbSet<Reservation> Reservation { get; set;  }

        public DbSet<UserRatingLog> UserRatingLog { get; set; }
