...
namespace Library.Annotation
{
    public class BorrowsBookAnnotation : BaseEntityAnnotation<BorrowsBook>
    {
        ...
        public override void Annotate()
        {
            ...
            this.ModelBuilder.Property(b => b.BorrowDate).HasColumnName("borrow_date").HasColumnType("DATE");
            this.ModelBuilder.Property(b => b.ReturnDate).HasColumnName("return_date").HasColumnType("DATE");
            ...
            this.ModelBuilder.Property(b => b.IsReturned).HasColumnName("is_returned");
        }
    }
}
